...
//  /home/antonio/Slicer-Git/Slicer-SuperBuild-Debug/SlicerExecutionModel-build/GenerateCLP/bin/GenerateCLP --InputXML /home/antonio/Documents/CSIM-Toolkits/Slicer/CLI/AnomalousFiltersExtension/IADImageFilter/IADImageFilter.xml --OutputCxx /home/antonio/Documents/CSIM-Toolkits/Slicer/CLI/AnomalousFiltersExtension-build/IADImageFilter/IADImageFilterCLP.h
//
#include <cstdio>
#include <cstdlib>
#include <iostream>
...
#define GENERATE_TCLAP_PARSE \
 ...
 \
    msg.str("");msg << "A double value that represents the intensity of diffusion which is relative to the maximum diffusion spread accepted by the medium. The maximum values is set together with the Anomalous Parameter (q). (default: " << D << ")"; \
    TCLAP::ValueArg<double > DArg("d", "generalizeddiffusion", msg.str(), 0, D, "double", commandLine); \
 \
